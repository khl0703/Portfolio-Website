...
const socials = [
  {
    label: "Email",
    href: "mailto:your.email@mail.utoronto.ca", // TODO: Replace with your email
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/kihunlee", // TODO: Replace with your LinkedIn URL
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/kihunlee", // TODO: Replace with your GitHub URL
    icon: (
